...
<html lang="en-US">
<head>
<title>SUPERPLAY - компания по созданию видеоигр</title>
<meta charset="utf-8">
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx2-heading'>
							<p>
								 SUPERPLAY - компания, создающая игры, или дополнения к играм, например карты, модификации и т. д.
							</p>
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(/img/graphics/landing/fig.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
